...
try:
    ...
    """)
    conn.commit()
    print("Updated efficiency in player_coach_combined")
except Exception as e:
    conn.rollback()
    print("Error updating efficiency:", e)
...
try:
    ...
    """)
    conn.commit()
    print("Updated consistency in player_coach_combined")
except Exception as e:
    conn.rollback()
...
try:
    ...
    """)
    conn.commit()
    print("Updated recent_trend in player_coach_combined")
except Exception as e:
    conn.rollback()
    print("Error updating recent_trend:", e)
...
try:
    ...
    """)
    conn.commit()
    print("Updated cost_efficiency in player_coach_combined")
except Exception as e:
    conn.rollback()
    print("Error updating cost_efficiency:", e)
...
try:
    ...
    """)
    conn.commit()
    print("Updated proj_efficiency in coach_raw")
except Exception as e:
    conn.rollback()
    print("Error updating proj_efficiency:", e)

# --- Close the database connection ---
conn.close()
print("7DerivativeStats.py completed successfully.")
